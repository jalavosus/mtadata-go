...
type Station struct {
	...
	ComplexId       string           `protobuf:"bytes,9,opt,name=complex_id,json=complexId,proto3" json:"complex_id,omitempty"`
...
func (x *Station) GetComplexId() string {
	if x != nil {
		return x.ComplexId
	}
	return ""
...
func (x *StationComplex) GetComplexId() string {
	if x != nil {
		return x.ComplexId
	}
	return ""
...
var file_types_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x63,
	0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x78, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x6f, 0x6d, 0x70,
	...
	0x73, 0x42, 0x90, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var file_types_proto_goTypes = []interface{}{
	...
	(Division)(0),           // 6: mtadata.v1.Division
	(Borough)(0),            // 7: mtadata.v1.Borough
	(Structure)(0),          // 8: mtadata.v1.Structure
	(Route)(0),              // 9: mtadata.v1.Route
}
var file_types_proto_depIdxs = []int32{
	0,  // 0: mtadata.v1.Station.direction_labels:type_name -> mtadata.v1.DirectionLabels
	6,  // 1: mtadata.v1.Station.division:type_name -> mtadata.v1.Division
	7,  // 2: mtadata.v1.Station.borough:type_name -> mtadata.v1.Borough
	8,  // 3: mtadata.v1.Station.structure:type_name -> mtadata.v1.Structure
	9,  // 4: mtadata.v1.Station.daytime_routes:type_name -> mtadata.v1.Route
	1,  // 5: mtadata.v1.Station.gtfs_location:type_name -> mtadata.v1.GtfsLocation
	7,  // 6: mtadata.v1.StationComplex.borough:type_name -> mtadata.v1.Borough
	6,  // 7: mtadata.v1.StationComplex.divisions:type_name -> mtadata.v1.Division
	9,  // 8: mtadata.v1.StationComplex.daytime_routes:type_name -> mtadata.v1.Route
